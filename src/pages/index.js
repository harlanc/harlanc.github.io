...
export default function App() {
      ...
      <header className={classNames('hero', styles.hero)}>
        <div className={classNames(styles.heroContainer)}>
          ...
          <Link
            ...
            to={latestVersion.path + '/docs/getting-started/quickstart'}
          >
  ...
  //               message:
  //                 'Building simple, convenient, efficient, and secure live media service.',
  //               description:
  ...
  //           <Translate>Try a Demo2</Translate>
  //         </Link> */}
  //         <span className={styles.indexCtasGitHubButtonWrapper}>
  //           <iframe
  //             className={styles.indexCtasGitHubButton}
  //             src="https://ghbtns.com/github-btn.html?user=harlanc&amp;repo=xiu&amp;type=star&amp;count=true&amp;size=large"
  //             width={160}
  //             height={30}
  //             title="GitHub Stars"
  //           />
